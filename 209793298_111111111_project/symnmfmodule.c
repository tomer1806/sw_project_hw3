...
static PyMethodDef symnmf_methods[] = {
    ...
    {"sym",    (PyCFunction)sym_api,    METH_VARARGS, "Compute similarity matrix"},
    {"ddg",    (PyCFunction)ddg_api,    METH_VARARGS, "Compute diagonal degree matrix"},
    {"norm",   (PyCFunction)norm_api,   METH_VARARGS, "Compute normalized similarity matrix"},
    {"symnmf", (PyCFunction)symnmf_api, METH_VARARGS, "Do full symNMF algorithm"},
    {NULL, NULL, 0, NULL}
};
